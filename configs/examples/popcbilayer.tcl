...
#set bondtypelist [list { 0 CH PH } { 1 PH GL } { 2 GL E1 } { 3 GL E2 } { 4 E1 AS } { 5 E2 AS } { 6 AS AS } { 7 AS AD } { 8 AS AE } ]
...
#set angltypelist [list { 10 CH PH GL } { 11 PH GL E1 } { 12 PH GL E2 } { 13 GL E1 AS } { 14 GL E2 AS } { 15  E1 AS AS } { 16 E2 AS AS } { 17 AS AS AS } { 18 AS AS AD } { 19 AS AD AS } {20 AS AS AE } ]
set angltypelist [list ]
# list of dihe names for each of types:{bondid {dihenames}} 
#set dihetypelist [list {21 CH PH GL E2 } { 22 E2 PH GL E1 } { 23 PH GL E1 AS } { 24 PH GL E2 AS } { 25 GL E1 AS AS } { 26 GL E2 AS AS } { 27 E1 AS AS AS } { 28 E2 AS AS AD } { 29 AS AS AS AS } { 30 AS AS AD AS } { 31 AS AS AS AE } { 32 AD AS AS AE } ]
...
set readcrdfilename "\"popcbilayer_" 
append readcrdfilename $numberoflipid
append readcrdfilename "/popcbilayer_"
append readcrdfilename $numberoflipid
...
#the value of lengthx equals to that in the readfiles/popcbilayer.init.crd
set lengthx 99.168
