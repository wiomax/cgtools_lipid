...
# nbead_mol=17 [llength [lindex [lindex [lindex $moltypelists 0] 2] 0]  
# nbond_mol=16 [llength [lindex [lindex [lindex $moltypelists 0] 2] 1] 
# nangl_mol=15 [llength [lindex [lindex [lindex $moltypelists 0] 2] 2]
# ndihe_mol=14 [llength [lindex [lindex [lindex $moltypelists 0] 2] 3]
#
...
# nnbond_set=36  [llength [lindex [lindex [lindex $moltypelists 0] 3] 4]     
# ntype_nbonds=27 (implicit)
# [lindex [lindex $moltypelists 0] 2] is $dopclist: used in placemol for setting positions, bonds, angles, and dihedrals of molecule
# [lindex [lindex $moltypelists 0] 3] is $dopctypelist used mainly for setting the potentials, also used in placemol
...
set readcrdfilename "\"dopcbilayer_" 
append readcrdfilename $numberoflipid
append readcrdfilename "/dopcbilayer_"
append readcrdfilename $numberoflipid
...
set lengthx [expr sqrt(72.4*$numberoflipid*0.5)]
lappend setbox_l $lengthx
lappend setbox_l $lengthx
lappend setbox_l 151.28 
unset lengthx
set linetension 0
