...
source [file join [file dirname [info script]] rdfintermol.tcl]
...
source [file join [file dirname [info script]] gelclusters_all.tcl]
source [file join [file dirname [info script]] gelclusters_largest.tcl]
